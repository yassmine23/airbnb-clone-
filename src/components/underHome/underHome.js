...
/////////////////////////////////
            ...
            <Grid item xs={7}>
                            ...
                            <Avatar style={{position: 'absolute',top: 50, right: '2%'}}  src="https://a0.muscache.com/im/pictures/user/d4a7051c-d7e9-46cc-bcbc-6389a7a4509b.jpg?im_w=240"/> */}
                                        <Grid container>
                                            ...
                                            <Grid item xs={1}>
                                                <Box  p={2}> 
                                            <Avatar  src="https://a0.muscache.com/im/pictures/user/d4a7051c-d7e9-46cc-bcbc-6389a7a4509b.jpg?im_w=240"/> 
                                                </Box>
                                            </Grid>
                                            </Grid>
                            </Box>
  ...
  {/* Right side */}
    <Grid item xs={5} style={{position:'relative', marginTop:'50px'}}>
        <Box style={{height:'100hv' , boxShadow:'0px 1px 26px -6px rgba(0,0,0,0.59)',position:'sticky',top:'20px',bottom:'599px', marginLeft:'5%',  width:'50wv',borderRadius:'20px', border:'1px solid lightgray'}}   p={2}> 
                <Grid container>
                        <Grid item xs={6}>
                            <Box  p={2}> 
