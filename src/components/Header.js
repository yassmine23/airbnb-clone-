        ...
        >
          ...
          <Box style={{ display: isOpen ? "flex" : "none" }}>
            <Nav>
              ...
              <Nav.Item>
                <Nav.Link className="fw-bold p-3">
                  {t("Onlineexperiences")}
                </Nav.Link>
              </Nav.Item>
            </Nav>
            ...
            <Box sx={flexCenter}>
              ...
              <Stack>
                ...
                >
                  {isEmpety ? (
                    <Box>
                      <MenuItem onClick={signUp}>{t("singup")}</MenuItem>
                      <MenuItem onClick={log}>{t("login")}</MenuItem>
                    </Box>
                  ) : (
                    <Box>
                      <MenuItem onClick={profile}>{t("Profile")}</MenuItem>
                      <MenuItem onClick={favourit}>{t("WishList")}</MenuItem>
                    </Box>
                  )}
                  <Divider />
                  <MenuItem>{t("hostyourhome")}</MenuItem>
                  <MenuItem>{t("experience")}</MenuItem>
                  ...
                  <div className="col-4 p-1">
                    ...
                    >
                      <img
                        ...
                        alt="..."
                      />
                      <span className="py-2">I'm flexible</span>
                    </button>
                  </div>
                  ...
                  <div className="col-4 p-1">
                    ...
                    >
                      <img
                        ...
                        alt="..."
                      />
                      <span className="py-2">Europe</span>
                    </button>
                  </div>
                  ...
                  <div className="col-4 p-1">
                    ...
                    >
                      <img
                        ...
                        alt="..."
                      />
                      <span className="py-2">Turkey</span>
                    </button>
                  </div>
                  ...
                  <div className="col-4 p-1">
                    ...
                    >
                      <img
                        ...
                        alt="..."
                      />
                      <span className="py-2">United States</span>
                    </button>
                  </div>
                  ...
                  <div className="col-4 p-1">
                    ...
                    >
                      <img
                        ...
                        alt="..."
                      />
                      <span className="py-2">Italy</span>
                    </button>
                  </div>
                  ...
                  <div className="col-4 p-1">
                    ...
                    >
                      <img
                        ...
                        alt="..."
                      />
                      <span className="py-2">Africa</span>
                    </button>
                  </div>
                </div>
              </div>
